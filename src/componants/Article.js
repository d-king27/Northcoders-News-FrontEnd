...
class Article extends React.Component {
    ...
    genHandlePostClick(comment,context){
        return (event)=>{
    ...
    renderComments(arr) {
        ...
        return arr.map((item) => {
            ...
            return <div key={item._id}className='left-align z-depth-2 hoverable'>
                <li className='flow-text'style={styleC}>{item.body}</li>
                <li className='flow-text'style={styleV}>Posted by: {item.created_by}</li>
                <li className='flow-text'style={styleV}>{item.votes} votes</li>
                <a className="btn-floating btn-large waves-effect waves-light red" style={styleB} onClick={this.genHandleClick(item._id,true)}><i className="material-icons">arrow_upward</i></a>
                <a className="btn-floating btn-large waves-effect waves-light red" style={styleB} onClick={this.genHandleClick(item._id,false)}><i className="material-icons">arrow_downward</i></a>
    ...
    render () {
        ...
        if(this.state.article===null){
            ...
            <div className='Nav'>
                ...
                <a className="btn-floating btn-large waves-effect waves-light red" onClick={this.handleUpClickArticle}><i className="material-icons">exposure_plus_1</i></a> <a className="btn-floating btn-large waves-effect waves-light red" onClick={this.handleDownClickArticle}><i className="material-icons">exposure_neg_1</i></a> <span className='flow-text' style={styleV}>{this.state.votes}</span> 
