...
class CommentBox extends React.Component{
    ...
    render(){
        return(<div>
            ...
            <button className={this.getBoolean('btn waves-effect waves-light red')} onClick={this.props.handlePostClick(this.state.comment,this)} type="submit" name="action">Post Comment
            </button>
        </div>
        );}  
}
